...
new_path = std_path + '\\NMSU_Software_Projects\\SWTDI_GUI\\SWTDI_V0_0_4\\PlotsData\\Main\\House1\\Room1\\'
...
# try:
#     file = os.open(new_path + 'outletPlotDataH%sR%sO%s.txt' % (house, room, outlet), flags)
...
class dynPlot1(mplCanvas):
    ...
    def update_figure(self):
        self.axes.clear()
        #f = open(std_path + '\\NMSU_Software_Projects\\SWTDI_GUI\\SWTDI_V0_0_4\\PlotsData\\Main\\House1\\Room1\\outletPlotDataH1R1O1.txt', 'r')
        with open(std_path + '\\NMSU_Software_Projects\\SWTDI_GUI\\SWTDI_V0_0_4\\PlotsData\\Main\\House1\\Room1\\outletPlotDataH1R1O1.txt', 'r') as f:
            d = f.readlines()
        f.close()
        x = []
        y = []
