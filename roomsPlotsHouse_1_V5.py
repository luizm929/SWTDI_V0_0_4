...
new_path = std_path + ('\\SWTDI_GUI\\SWTDI_V0_0_4\\PlotsData\\Main\\House1\\')
...
try:
    file = os.open(new_path + 'powerPlots_Rooms.txt', flags)
...
class dynPlot1(mplCanvas):
    ...
    def update_figure(self):
        self.axes.clear()
        f = open(std_path+'SWTDI_GUI\\SWTDI_V0_0_4\\PlotsData\\Main\\House1\\powerPlots_Rooms.txt', 'r')
...
class dynPlot12(mplCanvas):
    ...
    def compute_initial_figure(self):
        self.axes.plot([0, 1, 2, 3], [0, 0, 0, 0], 'r', color='black')
