...
from OutletsMain import Ui_outlets

matplotlib.use("Qt5Agg")
from PyQt5 import QtCore
from PyQt5.QtWidgets import (QGridLayout)
import roomsPlotsHouse_1_V5
# icon size
x = 60
y = 50
...
class Ui_rooms(object):
    def __init__(self):
        super(Ui_rooms, self).__init__()

    def home1(self):
        print("Room 1 clicked")
        self.OutletsMain = QtWidgets.QMainWindow()
        self.ui = Ui_outlets()
        self.ui.setupUi(self.OutletsMain)
        # w.hide()
        self.OutletsMain.show()
        # w.hide()

    def home2(self):
        print("Room 2 clicked")

    def home3(self):
        print("Room 3 clicked")

    def home4(self):
        print("Room 4 clicked")

    def home5(self):
        print("Room 5 clicked")

    def home6(self):
        print("Room 6 clicked")

    def home7(self):
        print("Room 7 clicked")

    def home8(self):
        print("Room 8 clicked")

    def home9(self):
        print("Room 9 clicked")

    def home10(self):
        print("Room 10 clicked")

    def home11(self):
        print("Room 11 clicked")

    def home12(self):
        print("Room 12 clicked")

    def home13(self):
        print("Room 13 clicked")

    def home14(self):
        print("Room 14 clicked")

    def home15(self):
        print("Room 15 clicked")

    def home16(self):
        print("Room 16 clicked")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("SWTDI Rooms Window", "SWTDI Rooms Window"))
...
from roomsPlotsHouse_1_V5 import dynPlot1, dynPlot2, dynPlot3, dynPlot4, dynPlot5, dynPlot6, dynPlot7, dynPlot8, dynPlot9, dynPlot10, dynPlot11, dynPlot12
